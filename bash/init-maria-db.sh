...
-- CREATE USER IF NOT EXISTS 'healthcheck'@'::1' IDENTIFIED BY '${DB_HEALTHCHECK_PW}';
-- ALTER USER 'healthcheck'@'::1' IDENTIFIED BY '${DB_HEALTHCHECK_PW}';
-- GRANT SELECT, PROCESS ON *.* TO 'healthcheck'@'::1';
